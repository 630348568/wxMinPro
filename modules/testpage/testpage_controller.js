...
let optionWarnService = resouse_.optionWarnService;
let diningSer = resouse_.diningSer.diningService;
let wxPublicService = resouse_.wxPublicService;
let opGetPlatGoodsTypeListFn = function(this_,myData){//查询店铺商品分类--操作
		...
		let myData_ = myData.theApp.mainSer.deepCopyFn(myData);
